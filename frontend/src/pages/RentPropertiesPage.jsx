...
const RentPropertiesPage = () => {
  ...
  const MapSection = () => (
    <div style={{ 
      ...
      {/* Property markers on map based on actual rental data */}
      ...
      <div style={{ width: '380px', backgroundColor: '#ffffff', borderRight: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', height: '100vh', position: 'sticky', top: 0 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            {/* Price Range */}
            <div>
              <h3 style={{ fontSize: '16px', fontWeight: '500', color: '#111827', marginBottom: '12px', margin: '0 0 12px 0' }}>Weekly Rent</h3>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                  <input type="radio" name="bedrooms" value="2" defaultChecked style={{ marginRight: '12px' }} />
                  <span style={{ fontSize: '14px', color: '#374151' }}>2</span>
                </label>
                <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                  <input type="radio" name="bedrooms" value="3" style={{ marginRight: '12px' }} />
